...
func main() {
    ...
    flag.StringVar(&cfg.db.dsn, "db-dsn", os.Getenv("GUESSR_DB_DSN"), "PostgreSQL DSN")
    flag.IntVar(&cfg.db.maxOpenConns, "db-open-conns", 25, "PostgreSQL max open connections")
